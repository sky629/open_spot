...
@Repository
interface LocationStatsJpaRepository : JpaRepository<LocationStatsJpaEntity, UUID> {
    ...
    @Query(
        """
        SELECT ls FROM LocationStatsJpaEntity ls
    ...
    fun findLatestDailyStatsByLocationId(@Param("locationId") locationId: UUID): LocationStatsJpaEntity?
    ...
    fun findLatestMonthlyStatsByLocationId(@Param("locationId") locationId: UUID): LocationStatsJpaEntity?
    ...
    fun findLatestYearlyStatsByLocationId(@Param("locationId") locationId: UUID): LocationStatsJpaEntity?
    ...
    @Query(
        ...
        FROM LocationStatsJpaEntity ls
        WHERE ls.statsDate = :statsDate
        AND ls.statsType = 'DAILY'
        """
    )
