...
@Repository
interface LocationVisitJpaRepository : JpaRepository<LocationVisitJpaEntity, UUID> {
    ...
    @Query(
        """
        SELECT lv FROM LocationVisitJpaEntity lv
    ...
    @Query(
        ...
        FROM LocationVisitJpaEntity lv
    ...
    fun findLatestVisitByUser(@Param("userId") userId: UUID): LocationVisitJpaEntity?
    ...
    fun findLatestVisitByLocation(@Param("locationId") locationId: UUID): LocationVisitJpaEntity?
