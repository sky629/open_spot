...
class SocialAccount(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is SocialAccount) return false
        return userId == other.userId && provider == other.provider && providerId == other.providerId
    }
    ...
    override fun toString(): String {
        return "SocialAccount(userId=$userId, provider=$provider, providerId='$providerId', email='$email')"
    }
